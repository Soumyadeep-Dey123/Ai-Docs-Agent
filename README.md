...
- [ ] Stage 2 — Creation of system prompt, structured answer display
- [ ] Stage 3 — Feed extra data(manually) and display a structured response
- [ ] Stage 4 — Use a webscraper to fetch data and feed it along with the response
